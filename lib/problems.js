...
//         table[i] = false;
//     }
//     if ( remainingSteps < nums[i] ) remainingSteps = nums[i];
//   }
...
//     let skipToLeft = table[i - 2] === undefined ? 0 : table[i - 2];
//     let bestWithNum = nums[i] + skipToLeft;
//     let bestWithoutThisNum = table[i - 1];
//     let largerNum = bestWithNum > bestWithoutThisNum ? bestWithNum : bestWithoutThisNum;
//     table[i] = largerNum;
//   }
